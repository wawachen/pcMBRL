...
from pyrep.networks.MultiOneHotCategorical import MultiOneHotCategorical
from pyrep.networks.MultiSoftMax import MultiSoftMax
from pyrep.common.torch_util import resolve_activate_function
