...
class Drone_Env_bacterium:
    ...
    def __init__(self,args,rank,env_name,num_agents):
        ...
        self.field_size = self.args.field_size/2 
        ...
        self.model_handles,_ = self.import_agent_models()
    ...
    # def check_inside2(self,pos):
    #     if pos[0] > -5 and pos[0] < 5 and pos[1] > -5 and pos[1] < 5:
    #         return 1
    #     else:
    #         return 0
