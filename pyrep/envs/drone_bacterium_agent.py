...
class Drone:
    ...
    def bacterium_controller_laser(self,obj):
        self.counter += 1
        print("counter",self.counter)
        
        self.current_concentration = self.agent.get_concentration(obj)
        ...
        if self.current_concentration == 0:
            ...
            self.speed = self.max_speed/(self.current_concentration*40)
