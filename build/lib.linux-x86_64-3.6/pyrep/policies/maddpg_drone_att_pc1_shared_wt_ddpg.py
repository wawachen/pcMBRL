import torch
import os
from pyrep.networks.model_attention_shared_wt import Actor_attf_ddpg as Actor1
    ...
    def select_actions(self, o, noise_rate, epsilon,use_gpu,logger):
        ...
        for i in range(self.args.n_agents):
            if np.random.uniform() < epsilon:
                ...
                pis = self.actor_network(inputs[i],logger=logger, iter_n=self.niter) #n*[none, adim]
                pi = pis.squeeze(0)
