import torch
import os
from pyrep.networks.model_attention1 import Actor_att1 as Actor1
from pyrep.networks.model_attention1 import Critic_att1 as Critic1
import numpy as np
...
class MADDPG:
    ...
    def select_action(self, o, noise_rate, epsilon, use_gpu):
        #[none, sdim]
        us = []
    ...
    def train(self, transitions, other_agents, logger, use_gpu):
        ...
        r = transitions['r_%d' % self.agent_id]  # 训练时只需要自己的reward [none,1]
