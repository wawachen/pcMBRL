...
import torch
import os
from pyrep.policies.maddpg_drone_scratch_pri import MADDPG
...
class Agent:
    ...
    def learn(self, transitions, w_id):
        delta, train_step = self.policy.train(transitions, w_id)
        return delta, train_step
