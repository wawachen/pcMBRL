from pyrep.policies.maddpg_agent_o import Agent  #modify
...
class Rollout:
    def __init__(self, args, env):
        ...
        self.log_path = os.getcwd()+"/log_turtle3_attp"
    ...
    def run(self):
        ...
        for i in range(self.max_episodes):
            ...
            for t in range(self.episode_limit):
                ...
                if self.buffer.current_size >= self.args.batch_size:  #self.args.batch_size
