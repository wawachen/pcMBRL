...
class Drone_base(Object):
    ...
    def __init__(self, count:int, num_propeller:int, name:str):
        ...
        self.vs_floor = VisionSensor('Quadricopter_floorCamera')  
        self.vs_front = VisionSensor('Quadricopter_frontCamera')
        ...
        self.velocities = np.array([0.0,0.0,0.0,0.0])
    ...
    def get_picture(self):
        ...
        rgb_fr = self.vs_front.capture_rgb()
        depth_fr = self.vs_front.capture_depth()

        return  [rgb_fl, depth_fl, rgb_fr, depth_fr]
