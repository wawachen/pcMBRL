...
class Drone_Env:
    ...
    def __init__(self,env_name,num_agents):
        ...
        for i,agent in enumerate(self.agents):
            ...
            #observation space
            obs_dim = len(self.observation_callback(agent,i))
            # print(obs_dim)
    ...
    def generate_goal(self):
        ...
        if self.num_a == 3:
            goal_points = np.array([[2.8,0,1.7],[0,0,1.7],[-2.8,0,1.7]]) #[-1.25,0,0.005],[0,1.25,0.005],[1.25,0,0.005]
    ...
    def reset_world(self):
        ...
        obs_n = []
        for i,agent in enumerate(self.agents):
            obs_n.append(self.observation_callback(agent,i))
    ...
    def observation(self, agent, index):
        # get positions of all entities in this agent's reference frame
        entity_pos = []
        entity_pos.append((self.goals[index,:2]-agent.get_2d_pos())/15)
        entity_pos.append(self.goals[index,:2]/15) 
