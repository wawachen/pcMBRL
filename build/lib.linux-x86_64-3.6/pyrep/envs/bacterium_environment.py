...
class Drone_Env:
    ...
    def generate_goal(self):
        ...
        goal_points = np.array([[-3,0,1.7],[3,0,1.7],[0,3,1.7]]) #[-1.25,0,0.005],[0,1.25,0.005],[1.25,0,0.005]
    ...
    def step(self, action_n):
        ...
        # im = self.agents[0].get_rgb_image()
        # print(im.shape)
        
        # im = Image.fromarray(im).convert('RGB') 
        # cv2.imwrite("frame_%d.png"%self.time_step, im)
        # im.save("frame_%d.png"%self.time_step)
    ...
    def observation(self, agent):
        ...
        return np.concatenate([agent.agent.get_velocity()[0][:2]] + entity_pos + other_pos)
