...
class Drone_Env:
    ...
    def __init__(self,env_name,num_agents,rank):
        self.rank = rank
    ...
    #     return np.concatenate([agent.get_2d_vel()]+ [agent.get_2d_pos()/5] + other_vel + other_pos + other_live + entity_pos)
