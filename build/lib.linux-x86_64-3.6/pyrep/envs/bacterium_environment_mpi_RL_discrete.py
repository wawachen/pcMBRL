...
from pyrep.envs.drone_RL_agent import Drone_s_dis
...
class Drone_Env:
    ...
    def __init__(self,args,env_name,num_agents):
        ...
        self.agents = [Drone_s_dis(i) for i in range(num_agents)]
        ...
        for agent in self.agents:
            ...
            if self.discrete_action_space:
                u_action_space = spaces.Discrete(4) #3*3
            else:
    ...
    def random_position_spread(self):
        ...
        for i in range(self.num_a):
            ...
            model_handles.append(m1)
            objs.append(m)
            self.agents.append(Drone_s_dis(i))
            if i == 0:
